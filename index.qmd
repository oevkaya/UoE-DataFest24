...
ASA DataFest is an international data analysis competition where teams of up to five undergraduate students attack a large, complex, and surprise dataset over a weekend. Your job is to find and communicate insights into these data. The teams that impress the judges will win prizes and glory!

This year we're hosting the second ASA DataFest at Edinburgh on 22-24 March! ASA DataFest is a weekend-long undergraduate data analysis competition where teams of 2-5 undergraduates work to reveal insights into a rich, complex, and surprise dataset. 

The School of Maths is hosting an ASA DataFest event this year for the second time, and we hope you'll be a part of it! Additionally, we're joining forces with Heriot-Watt and bringing together students from the two universities, in person for this year, after a long time!

## Event details

**When:** Friday, March 22 at 5:00pm - Sunday, March 24 at 5:00pm

**Where:** Nuclues Building, University of Edinburgh
